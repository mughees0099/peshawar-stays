...
export default function HostDashboard() {
  ...
  const [showPropertyDetails, setShowPropertyDetails] = useState<number | null>(
    null
  );
  const [showEditProperty, setShowEditProperty] = useState<number | null>(null);
  const [showBookingDetails, setShowBookingDetails] = useState<number | null>(
    null
  );
      ...
      <div className="container mx-auto px-4 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Card className="border-0 shadow-lg">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Add rooms to existing properties
                  </p>
                  <Dialog open={showAddRoom} onOpenChange={setShowAddRoom}>
                    ...
                    <DialogContent className="max-w-2xl">
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          Add a new room to one of your existing properties
                        </DialogDescription>
                      </DialogHeader>
                      <div className="space-y-4">
                        <div>
                          <Label htmlFor="select-property">
                            Select Property
                          </Label>
                          <Select>
                            <SelectTrigger>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button
                        ...
                        onClick={() =>
                          alert(
                            `Contacting ${booking.guestName} at ${booking.guestEmail}`
                          )
                        }
                      >
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-semibold text-primary mb-2">
                  No reviews to manage yet
                </h3>
                <p className="text-muted-foreground mb-4">
                  Guest reviews will appear here once you start receiving
                  bookings and guests complete their stays.
                </p>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center space-x-4">
                    <Avatar className="h-20 w-20">
                      ...
                      <AvatarFallback className="bg-luxury-gold text-primary text-lg">
                        MH
                      </AvatarFallback>
                    </Avatar>
        ...
        {showPropertyDetails && (
          <Dialog
            ...
            onOpenChange={() => setShowPropertyDetails(null)}
          >
                ...
                {properties.find((p) => p.id === showPropertyDetails) && (
                  <div>
                    ...
                    <p>
                      Revenue: PKR{" "}
                      {properties
                        .find((p) => p.id === showPropertyDetails)
        ...
        {showEditProperty && (
          <Dialog
            ...
            onOpenChange={() => setShowEditProperty(null)}
          >
            <DialogContent className="max-w-2xl">
              <DialogHeader>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    defaultValue={
                      properties.find((p) => p.id === showEditProperty)?.name
                    }
                  />
                </div>
                <div>
                  ...
                  <Input
                    defaultValue={
                      properties.find((p) => p.id === showEditProperty)
                        ?.location
                    }
                  />
                </div>
                ...
                {recentBookings.find((b) => b.id === showBookingDetails) && (
                  <div>
                    ...
                    <p>
                      Total: PKR{" "}
                      {recentBookings
                        .find((b) => b.id === showBookingDetails)
