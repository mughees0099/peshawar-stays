...
import { Search, MapPin, Star, Filter, Grid, List, Wifi, Car, Coffee, Waves } from "lucide-react"
...
const hotels = [
  ...
  },
  {
    ...
    type: "Guest House",
    description: "Comfortable and affordable accommodation with a homely atmosphere.",
  },
  {
    id: 4,
    ...
    type: "Guest House",
    description: "Budget-friendly option with essential amenities and friendly service.",
  },
  {
    id: 5,
    ...
    amenities: ["Wifi", "Parking", "Restaurant", "Pool"],
    type: "Luxury Hotel",
    description: "Premium luxury hotel with exceptional dining and spa facilities.",
  },
  {
    id: 6,
    ...
    type: "Guest House",
    description: "Simple and clean accommodation for budget-conscious travelers.",
  },
]
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-6">
              <Link href="/hotels" className="text-foreground font-medium">
                Browse Hotels
              </Link>
          ...
          <div className="lg:w-3/4">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
              <div>
                ...
                <p className="text-muted-foreground">{filteredHotels.length} properties found</p>
              </div>
                  ...
                  >
                    <div
                      className={`relative overflow-hidden ${
                        viewMode === "list" ? "w-64 flex-shrink-0" : "rounded-t-lg"
                      }`}
                    >
                      <Image
                      ...
                      />
                      <Badge className="absolute top-3 left-3 bg-white text-gray-900">{hotel.type}</Badge>
                    </div>
                    <CardContent className={`p-4 ${viewMode === "list" ? "flex-1" : ""}`}>
                      ...
                      {viewMode === "list" && <p className="text-sm text-muted-foreground mb-3">{hotel.description}</p>}
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <span className="text-lg font-bold">PKR {hotel.price.toLocaleString()}</span>
